...
if __name__ == '__main__':
    ...
    hosts = pd.read_csv('/opt/odoo/clvsol_clvhealth_jcafb/project/host.csv', delimiter=';', index_col='name')
    ...
    cli = CLI(
        # super_user_pw='*',
        super_user_pw=creds(host_name, 'master_pw'),
        # admin_user_pw='*',
        admin_user_pw=creds(host_name, 'user_pw'),
        # data_admin_user_pw='*',
        data_admin_user_pw=creds(host_name, 'data_user_pw'),
        # dbname='*',

...
def jcafb_2018_export_2017_update_sqlite(client, db_path, conn_string):
    ...
    table_name = 'clv_address_category'
    print('-->', client, address_category_args, db_path, table_name)
    print('--> Executing clv_address_category_export_sqlite_10()...')
    print()
    clv_address_category_export_sqlite_10(client, address_category_args, db_path, table_name)
    ...
    address_history_args = []
    table_name = 'clv_address_history'
    print('-->', client, address_history_args, db_path, table_name)
    print('--> Executing clv_address_history_export_sqlite_10()...')
    print()
    ...
    table_name = 'clv_person_address_role'
    print('-->', client, person_address_role_args, db_path, table_name)
    print('--> Executing clv_person_address_role_export_sqlite_10()...')
    print()
    clv_person_address_role_export_sqlite_10(client, person_address_role_args, db_path, table_name)
    ...
    table_name = 'clv_document_category'
    print('-->', client, document_category_args, db_path, table_name)
    print('--> Executing clv_document_category_export_sqlite_10()...')
    print()
    clv_document_category_export_sqlite_10(client, document_category_args, db_path, table_name)

    document_args = []
    table_name = 'clv_document'
    print('-->', client, document_args, db_path, table_name)
    print('--> Executing clv_document_export_sqlite_10()...')
    print()
    clv_document_export_sqlite_10(client, document_args, db_path, table_name)

    document_log_args = []
    table_name = 'clv_document_log'
    print('-->', client, document_log_args, db_path, table_name)
    print('--> Executing clv_document_log_export_sqlite_10()...')
    print()
    clv_document_log_export_sqlite_10(client, document_log_args, db_path, table_name)
...
def jcafb_2018_import_2017_update_sqlite(client, db_path, conn_string):
    ...
    print('--> Executing clv_address_import_sqlite_10()...')
    print()
    clv_address_import_sqlite_10(
        client, address_args, db_path, table_name, global_tag_table_name, category_table_name,
        res_country_table_name, res_country_state_table_name, l10n_br_base_city_table_name,
        hr_employee_table_name, history_marker_table_name
    )
    ...
    history_marker_table_name = 'clv_history_marker'
    print('-->', client, address_history_args, db_path, table_name,
          address_table_name, category_table_name, hr_employee_table_name,
          history_marker_table_name)
    print('--> Executing clv_address_history_import_sqlite_10()...')
    print()
    clv_address_history_import_sqlite_10(client, address_history_args, db_path, table_name,
                                         address_table_name, category_table_name, hr_employee_table_name,
                                         history_marker_table_name)
    ...
    address_table_name = 'clv_address'
    history_marker_table_name = 'clv_history_marker'
    person_address_role_table_name = 'clv_person_address_role'
    print(
        '-->',
        client, person_args, db_path, table_name, global_tag_table_name, category_table_name, address_table_name,
    ...
    person_address_role_table_name = 'clv_person_address_role'
    print('-->', client, person_history_args, db_path, table_name,
          person_table_name, category_table_name, hr_employee_table_name,
          history_marker_table_name, address_table_name, person_address_role_table_name)
    print('--> Executing clv_person_history_import_sqlite_10()...')
    print()
    clv_person_history_import_sqlite_10(client, person_history_args, db_path, table_name,
                                        person_table_name, category_table_name, hr_employee_table_name,
                                        history_marker_table_name, address_table_name,
                                        person_address_role_table_name)
    ...
    print(
        '-->', client, person_address_history_args, db_path, table_name, global_tag_table_name,
        person_address_role_table_name, person_table_name, address_table_name, history_marker_table_name
    )
    print('--> Executing clv_person_address_history_import_sqlite_10()...')
    print()
    clv_person_address_history_import_sqlite_10(
        client, person_address_history_args, db_path, table_name, global_tag_table_name,
        person_address_role_table_name, person_table_name, address_table_name, history_marker_table_name
    )
    ...
    hr_employee_history_log_args = []
    table_name = 'hr_employee_history_log'
    hr_employee_history_table_name = 'hr_employee_history'
    res_users_table_name = 'res_users'
    print('-->', client, hr_employee_history_log_args, db_path, table_name,
          hr_employee_history_table_name, res_users_table_name)
    print('--> Executing hr_employee_history_log_import_sqlite_10()...')
    print()
    hr_employee_history_log_import_sqlite_10(client, hr_employee_history_log_args, db_path, table_name,
                                             hr_employee_history_table_name, res_users_table_name)
    ...
    res_users_table_name = 'res_users'
    print('-->', client, address_log_args, db_path, table_name, address_table_name, res_users_table_name)
    print('--> Executing clv_address_log_import_sqlite_10()...')
    print()
    clv_address_log_import_sqlite_10(client, address_log_args, db_path, table_name,
                                     address_table_name, res_users_table_name)

    address_history_log_args = []
    table_name = 'clv_address_history_log'
    address_history_table_name = 'clv_address_history'
    res_users_table_name = 'res_users'
    print('-->', client, address_history_log_args, db_path, table_name,
          address_history_table_name, res_users_table_name)
    print('--> Executing clv_address_history_log_import_sqlite_10()...')
    print()
    clv_address_history_log_import_sqlite_10(client, address_history_log_args, db_path, table_name,
                                             address_history_table_name, res_users_table_name)
    ...
    person_history_log_args = []
    table_name = 'clv_person_history_log'
    person_history_table_name = 'clv_person_history'
    res_users_table_name = 'res_users'
    print('-->', client, person_history_log_args, db_path, table_name,
          person_history_table_name, res_users_table_name)
    print('--> Executing clv_person_history_log_import_sqlite_10()...')
    print()
    clv_person_history_log_import_sqlite_10(client, person_history_log_args, db_path, table_name,
                                            person_history_table_name, res_users_table_name)

    person_address_history_log_args = []
    table_name = 'clv_person_address_history_log'
    person_address_history_table_name = 'clv_person_address_history'
    res_users_table_name = 'res_users'
    print('-->', client, person_address_history_log_args, db_path, table_name,
          person_address_history_table_name, res_users_table_name)
    print('--> Executing clv_person_address_history_log_import_sqlite_10()...')
    print()
    clv_person_address_history_log_import_sqlite_10(client, person_address_history_log_args, db_path, table_name,
                                                    person_address_history_table_name, res_users_table_name)
...
if __name__ == '__main__':
    ...
    # # ##### tkl-odoo10-jcafb-vm (2018-10-27) ######################################
    # #
    # db_path = '/opt/openerp/filestore/jcafb/export/sqlite/clvhealth_jcafb_2019_pmng.sqlite'
    # print('-->', client, db_path, conn_string)
    # print('--> Executing jcafb_2018_import_2018_person_mng_sqlite()...')
